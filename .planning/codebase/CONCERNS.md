...
- Files: `elliot/agents/graph_investigator.py:109,507,551,555,568,572,585-587,649,1024`, `elliot/analysis/pattern_matcher.py:192,203,228,423,430,434,438`, `backend/services/audit_runner.py:269`
...
- Files: `elliot/agents/graph_investigator.py:412-422,497-505,541-555`
...
- Note: `.env` file present at `elliot/.env` (loaded via `load_dotenv`)
...
- Files: `elliot/core/ipc.py`, `backend/services/audit_runner.py`
...
- Files: `elliot/core/orchestrator.py` (200+ lines, multi-agent coordination)
