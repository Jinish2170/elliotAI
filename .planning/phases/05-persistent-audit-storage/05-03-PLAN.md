...
must_haves:
  ...
  artifacts:
    - path: "elliot/screenshots/storage.py"
  ...
  key_links:
    - from: "elliot/screenshots/storage.py"
...
Output: elliot/screenshots/storage.py with ScreenshotStorage class handling all file operations.
</objective>
...
<task type="auto">
  ...
  <action>
    Create elliot/screenshots/storage.py with ScreenshotStorage class:
    ...
    2. Create elliot/screenshots/__init__.py (empty marker file)
  ...
  <verify>
    Run python -c "from elliot.screenshots.storage import ScreenshotStorage; s = ScreenshotStorage(); print('Storage base:', s.base_dir)"
  </verify>
  <done>
...
<verification>
1. Verify import: Run `python -c "from elliot.screenshots.storage import ScreenshotStorage; print('OK')"`
...
<success_criteria>
- elliot/screenshots/storage.py with ScreenshotStorage class
