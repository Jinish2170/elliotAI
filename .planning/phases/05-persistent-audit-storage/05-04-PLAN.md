...
must_haves:
  ...
  key_links:
    - from: "backend/routes/audit.py"
      ...
      pattern: "from elliot.db.repositories import AuditRepository"
    - from: "backend/routes/audit.py"
      to: "elliot/screenshots/storage.py"
      via: "import ScreenshotStorage"
      pattern: "from elliot.screenshots.storage import ScreenshotStorage"
    - from: "backend/routes/audit.py"
