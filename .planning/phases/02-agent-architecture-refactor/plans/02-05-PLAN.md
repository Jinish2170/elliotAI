...
depends_on:
  ...
  - "02-04-PLAN.md"
files_modified:
  - elliot/tests/test_security_integration.py
  - elliot/tests/test_migration_path.py
autonomous: true
requirements:
  - CORE-01
  - CORE-01-4
must_haves:
  ...
  artifacts:
    ...
    - path: "elliot/tests/test_migration_path.py"
      ...
      min_lines: 100
  key_links:
    - from: "elliot/tests/test_security_integration.py"
    ...
    - from: "elliot/tests/test_migration_path.py"
      to: "elliot/core/orchestrator.py"
...
Create `elliot/tests/test_security_integration.py` with test classes:
...
Create `elliot/tests/test_migration_path.py` with test classes:
