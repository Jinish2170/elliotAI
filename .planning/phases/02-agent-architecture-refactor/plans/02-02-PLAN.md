...
files_modified:
  ...
  - elliot/analysis/security_headers.py
  - elliot/analysis/phishing_checker.py
  - elliot/analysis/redirect_analyzer.py
  - elliot/analysis/js_analyzer.py
...
must_haves:
  ...
  artifacts:
    - path: "elliot/agents/security_agent.py"
      ...
      min_lines: 100
    - path: "elliot/analysis/__init__.py"
  ...
  key_links:
    ...
    - from: "elliot/analysis/security_headers.py"
      to: "elliot/analysis/__init__.py"
...
Create `SecurityModuleBase` in `elliot/agents/security_agent.py` (or `elliot/analysis/__init__.py`):
...
Update `elliot/agents/security_agent.py`:
