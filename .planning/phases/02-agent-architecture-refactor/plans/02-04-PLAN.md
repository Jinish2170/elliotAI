...
depends_on:
  ...
  - "02-03-PLAN.md"
files_modified:
  - elliot/tests/test_security_agent.py
...
must_haves:
  ...
  artifacts:
    ...
    - path: "elliot/tests/test_security_dataclasses.py"
      ...
      min_lines: 80
  key_links:
    - from: "elliot/tests/test_security_agent.py"
    ...
    - from: "elliot/tests/test_security_dataclasses.py"
      to: "elliot/core/types.py"
...
Create `elliot/tests/test_security_agent.py` with test classes:
...
Create `elliot/tests/test_security_dataclasses.py` with test classes:
