...
must_haves:
  ...
  artifacts:
    - elliot/agents/graph_investigator.py (modified with OSINT integration)
...
Modify elliot/agents/graph_investigator.py:

1. Add imports near top of file:
   ```python
   from elliot.osint.orchestrator import OSINTOrchestrator
   from elliot.osint.reputation import ReputationManager, VerdictType
...
Modify GraphResult dataclass in elliot/agents/graph_investigator.py:
