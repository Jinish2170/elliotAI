...
depends_on: ["10-01"]
files_modified:
  - elliot/analysis/security/owasp/__init__.py
  - elliot/analysis/security/owasp/a01_broken_access_control.py
  - elliot/analysis/security/owasp/a02_cryptographic_failures.py
  - elliot/analysis/security/owasp/a03_injection.py
  - elliot/analysis/security/owasp/a04_insecure_design.py
  - elliot/analysis/security/owasp/a05_security_misconfiguration.py
  - elliot/analysis/security/owasp/a06_vulnerable_components.py
  - elliot/analysis/security/owasp/a07_authentication_failures.py
  - elliot/analysis/security/owasp/a08_data_integrity.py
  - elliot/analysis/security/owasp/a09_logging_failures.py
  - elliot/analysis/security/owasp/a10_ssrf.py
autonomous: true
requirements:
  - SEC-01
user_setup: []
...
From elliot/analysis/dom_analyzer.py ( ScoutResult provides DOM metadata):
```python
class DOMAnalyzer:
...
From elliot/cwe/registry.py, key CWEs to map:
...
<task type="auto">
  ...
  <files>elliot/analysis/security/owasp/a01_broken_access_control.py, elliot/analysis/security/owasp/a02_cryptographic_failures.py, elliot/analysis/security/owasp/a03_injection.py</files>
  <action>
  ...
  <verify>
    <automated>python -c "from elliot.analysis.security.owasp.a01_broken_access_control import BrokenAccessControlModule; from elliot.analysis.security.owasp.a02_cryptographic_failures import CryptographicFailuresModule; from elliot.analysis.security.owasp.a03_injection import InjectionModule; print('A01, A02, A03 modules import successfully')"</automated>
  </verify>
...
<task type="auto">
  ...
  <files>elliot/analysis/security/owasp/a04_insecure_design.py, elliot/analysis/security/owasp/a05_security_misconfiguration.py, elliot/analysis/security/owasp/a06_vulnerable_components.py</files>
  <action>
  ...
  <verify>
    <automated>python -c "from elliot.analysis.security.owasp.a04_insecure_design import InsecureDesignModule; from elliot.analysis.security.owasp.a05_security_misconfiguration import SecurityMisconfigurationModule; from elliot.analysis.security.owasp.a06_vulnerable_components import VulnerableComponentsModule; print('A04, A05, A06 modules import successfully')"</automated>
  </verify>
...
<task type="auto">
  ...
  <files>elliot/analysis/security/owasp/a07_authentication_failures.py, elliot/analysis/security/owasp/a08_data_integrity.py, elliot/analysis/security/owasp/a09_logging_failures.py, elliot/analysis/security/owasp/a10_ssrf.py</files>
  <action>
  ...
  <verify>
    <automated>python -c "from elliot.analysis.security.owasp.a07_authentication_failures import AuthenticationFailuresModule; from elliot.analysis.security.owasp.a08_data_integrity import DataIntegrityFailuresModule; from elliot.analysis.security.owasp.a09_logging_failures import LoggingFailuresModule; from elliot.analysis.security.owasp.a10_ssrf import SSRFModule; print('A07, A08, A09, A10 modules import successfully')"</automated>
  </verify>
