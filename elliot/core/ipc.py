"""
IPC (Inter-Process Communication) Utilities for Elliot

Provides Queue-based communication between backend and Elliot subprocess
...
class ProgressEvent:
    ...
    This dataclass defines the schema for events sent from Elliot subprocess
