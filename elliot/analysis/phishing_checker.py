"""
Elliot — Phishing Database Checker
...
from elliot.analysis import SecurityModule

logger = logging.getLogger("elliot.analysis.phishing_checker")
...
class PhishingChecker(SecurityModule):
    ...
    async def _check_safe_browsing(self, url: str, result: PhishingResult) -> None:
        ...
        try:
            ...
            payload = json.dumps({
                "client": {"clientId": "elliot", "clientVersion": "3.0"},
                "threatInfo": {
                    "threatTypes": [
