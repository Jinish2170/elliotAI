...
if TYPE_CHECKING:
    from elliot.config.security_rules import (
        calculate_cvss_for_severity,
        get_cwe_for_finding,
        get_severity_for_finding,
    )

from elliot.analysis.security.base import SecurityFinding, SecurityModule, SecurityTier
from elliot.config import security_rules
