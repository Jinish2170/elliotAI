...
from elliot.analysis import ModuleInfo
from elliot.analysis.security.base import SecurityFinding as ModuleSecurityFinding
from elliot.analysis.security.base import SecurityModule, SecurityTier
from elliot.core.types import SecurityFinding as CoreSecurityFinding, Severity
from elliot.osint.types import (
    DarknetMarketplaceType,
    ExitRiskLevel,
    MarketplaceThreatData,
    OSINTResult,
)
from elliot.osint.ioc_detector import IOCDetector, IOCType
from elliot.darknet import OnionDetector, MarketplaceType

logger = logging.getLogger("elliot.analysis.security.darknet")
...
class DarknetAnalyzer(SecurityModule):
    ...
    async def analyze(
        ...
        from elliot.config.darknet_rules import get_darknet_cvss_score
    ...
    async def _check_marketplace_threats(
        ...
        from elliot.osint.sources.darknet_alpha import AlphaBayMarketplaceSource
        from elliot.osint.sources.darknet_hansa import HansaMarketplaceSource
        from elliot.osint.sources.darknet_empire import EmpireMarketplaceSource
        from elliot.osint.sources.darknet_dream import DreamMarketplaceSource
        from elliot.osint.sources.darknet_wallstreet import WallStreetMarketplaceSource
    ...
    async def _check_tor2web_exposure(self, url: str) -> bool:
        ...
        """
        from elliot.osint.sources.darknet_tor2web import Tor2WebDeanonSource
    ...
    def to_security_finding(
        ...
        Returns:
            SecurityFinding for the ELLIOT security pipeline
        """
