...
logger = logging.getLogger("elliot.analysis.security.utils")
...
def get_all_security_modules(package_path: str = "elliot.analysis.security") -> List[type[SecurityModule]]:
    """
    ...
    Args:
        package_path: Python package path to scan (default: elliot.analysis.security)
...
async def execute_all_modules(
    ...
    headers: dict = None,
    dom_meta: dict = None,
    package_path: str = "elliot.analysis.security",
