...
Deep OSINT and Social Engineering module for Elliot.
Detects:
...
from elliot.analysis.security.base import SecurityModule, SecurityTier, SecurityFinding as ModuleSecurityFinding
from elliot.core.types import SecurityFinding as CoreSecurityFinding, Severity

logger = logging.getLogger("elliot.analysis.security.social_engineering")
