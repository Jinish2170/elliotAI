...
from elliot.core.evidence_store import EvidenceStore
from elliot.config.dark_patterns import get_prompts_for_category, DARK_PATTERN_TAXONOMY
...
class TestJudgeStubs:
    ...
    def test_summarize_dark_patterns_no_vision_result(self):
        ...
        from elliot.agents.judge import JudgeAgent
