...
Purpose: Isolate CancelledError root cause by stripping away ELLIOT complexity.
...
# Add elliot to path for module imports
...
def build_minimal_graph() -> StateGraph:
    ...
    This isolates LangGraph behavior without ELLIOT complexity.
    """
...
async def test_error_handling_in_node():
    ...
    This provides baseline for comparing error behavior with full ELLIOT graph.
    """
