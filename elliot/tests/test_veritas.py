"""
Elliot Tests — Unit & Integration Tests
...
class TestCTIMeaningfulIndicators:
    ...
    def test_none_severity_excluded(self):
        ...
        from elliot.osint.ioc_detector import Indicator, IOCType, IOCSeverity
...
class TestTavilySignalExtraction:
    ...
    def _get_extract_fn(self):
        from elliot.osint.sources.tavily_source import TavilyReputationSource
