...
from elliot.core.types import SecurityResult
from elliot.core.ipc import ProgressEvent, SecurityModeStarted, SecurityModeCompleted
from elliot.core.orchestrator import AuditState, security_node_with_agent, security_node
import logging
...
class TestSecurityAgentModuleDiscovery:
    ...
    async def test_all_modules_discoverable(self):
        ...
        from elliot.analysis import SecurityModule, ModuleInfo
        from elliot.analysis.security_headers import SecurityHeaderAnalyzer
        from elliot.analysis.phishing_checker import PhishingChecker
