"""
Elliot Agent 1 â€” The Stealth Scout (Browser Automation)

The "Hands & Legs" of Elliot. Navigates target URLs, captures evidence.
...
if TYPE_CHECKING:
    from elliot.core.types import ExplorationResult, PageVisit, ScrollResult
...
from elliot.config.site_types import SiteType, classify_site_type

logger = logging.getLogger("elliot.scout")
...
try:
    from elliot.darknet.onion_detector import OnionDetector as _OnionDetector
    from elliot.darknet.tor_client import TORClient as _TORClient
...
class StealthScout:
    ...
    async def explore_multi_page(
        ...
        """
        from elliot.core.types import ExplorationResult, PageVisit
