"""
Elliot Agent — Security Analysis (Unified Security Modules with Tier Execution)

The "Security Shield" of Elliot. Analyzes websites for security vulnerabilities
...
from elliot.config.settings import (
...
from elliot.core.types import SecurityConfig, SecurityFinding, SecurityResult, Severity

# Tier execution utilities
try:
    from elliot.analysis.security.utils import get_all_security_modules, group_modules_by_tier, execute_tier
    from elliot.analysis.security.base import SecurityModule, SecurityTier, SecurityFinding as SecurityModuleFinding
    TIER_AVAILABLE = True
except ImportError:
...
try:
    from elliot.cwe.cvss_calculator import cvss_calculate_score, PRESET_METRICS, CVSSMetrics
    from elliot.cwe.registry import map_finding_to_cwe
    CVSS_AVAILABLE = True
except ImportError:
...
from elliot.analysis.security.darknet import DarknetAnalyzer
...
class SecurityAgent:
    ...
    Usage:
        ...
        from elliot.core.types import SecurityConfig
    ...
    def is_enabled(cls, url: str = "") -> bool:
        ...
        """
        from elliot.config.settings import should_use_security_agent
