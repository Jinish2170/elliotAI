...
from elliot.osint.types import OSINTResult, Tor2WebThreatData, ExitRiskLevel
from elliot.osint.sources.base import OSINTSource

logger = logging.getLogger("elliot.osint.sources.darknet_tor2web")
...
class Tor2WebDeanonSource(OSINTSource):
    ...
    async def query(
        ...
        **kwargs
        ...
        from elliot.osint.types import OSINTCategory, SourceStatus
