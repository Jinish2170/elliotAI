"""
Elliot Reporting — PDF Report Generator
...
logger = logging.getLogger("elliot.reporting")
...
class ReportGenerator:
    """
    Generate PDF audit reports from Elliot audit results.
    ...
    def generate(
        ...
        base_name = f"elliot_{domain}_{timestamp}"
    ...
    def _fallback_json(self, result: dict, url: str) -> Path:
        ...
        json_path = self._output_dir / f"elliot_{domain}_{ts}.json"
